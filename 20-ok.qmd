...
# OK-BCR18-AO is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "OK-BCR18-AO")
...
# OK-BCR18-PL is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "OK-BCR18-PL")
...
# OK-BCR18-RV is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "OK-BCR18-RV")
...
# OK-BCR19-AO is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "OK-BCR19-AO")
...
# OK-BCR19-PL is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "OK-BCR19-PL")
...
# OK-BCR19-RV is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "OK-BCR19-RV")
