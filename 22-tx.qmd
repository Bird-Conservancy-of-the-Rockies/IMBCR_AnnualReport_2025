...
# TX-BCR18-AO is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "TX-BCR18-AO")
...
# TX-BCR19-AO is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "TX-BCR19-AO")
