...
In `r year`, field observers completed 1,195 of 1,198 (99%) planned surveys throughout all or portions of BCRs `r summary$bcr` using the IMBCR design (@tbl-planned-completed, @fig-extent). Five surveys were completed above the funded sample effort in four strata. Reasons surveys were not completed are summarized in <a href="#sec-reasons">Table 2</a>.
