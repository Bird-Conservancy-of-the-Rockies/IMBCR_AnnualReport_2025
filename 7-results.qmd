...
In `r year`, field observers completed 1,627 of 1,193 (97%) planned surveys throughout all or portions of BCRs `r summary$bcr` using the IMBCR design (@tbl-planned-completed, @fig-extent). Two surveys were completed above the funded sample effort in two strata. Reasons surveys were not completed are summarized in <a href="#sec-reasons">Table 2</a>.

Observers conducted 13,455 point counts within the 1,193 surveyed sampling units between `r summary$first` and `r summary$last`, `r year`. They detected 165,395 individual birds representing 327 species.
