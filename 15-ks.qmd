...
# KS-BCR18-AO is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "KS-BCR18-AO")
...
# KS-BCR18-PL is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "KS-BCR18-PL")
...
# KS-BCR19-AO is a special value from the heddlr_loop.qmd file
x <- which(data$stratum == "KS-BCR19-AO")
